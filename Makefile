...
LIBFT_OFILES = $(addprefix libft/, ft_strstr.o ft_strmap.o ft_lstadd.o ft_strdel.o ft_memccpy.o ft_strlen.o ft_putchar_fd.o \
			...
			ft_putnwstr.o ft_wstrsize.o ft_itoa_base.o ft_uitoa_base.o)
PRINTF_OFILES = format_c.o format_p.o format_s.o ft_chrin_str.o ft_printf.o print_manager.o ft_printf_cast_unum.o\
			specificator_manager.o format_d_i.o format_n.o format_o.o 
INCLUDES = -I ./includes
