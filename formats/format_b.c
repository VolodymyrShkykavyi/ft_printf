...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/08 15:27:00 by vshkykav          #+#    #+#             */
/*   Updated: 2018/01/08 15:27:00 by vshkykav         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void format_b_print(t_specinfo *info, char *str, short str_len, short space_len)
{
	if (info->zero_minus != '-')
